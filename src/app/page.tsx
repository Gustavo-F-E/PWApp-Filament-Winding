  ...
  return (
    <section className="h-full w-full flex flex-col lg:grid lg:grid-rows-[repeat(23,1fr)] lg:grid-cols-[repeat(18,1fr)]">
        ...
        <main className="flex-1 w-full lg:row-[7/24] lg:col-[1/13] bg-blue-50 lg:grid lg:grid-rows-[repeat(17,1fr)] lg:grid-cols-[repeat(12,1fr)] lg:h-full">
            ...
            <div className="row-[3/7] col-[1/13] lg:col-[3/11] text-blue-950 text-center px-4 flex flex-col justify-center">
            ...
            {/* Icono de alerta */}
            <div className="row-[7/9] col-[1/13] lg:col-[3/11] flex items-center justify-center">
            ...
            <div className="row-[9/13] col-[1/13] lg:col-[3/11] text-blue-950 text-center px-4 flex flex-col justify-center text-fluid-base">
            <div>
                ...
                <span>&nbsp;{t("HomePage.recommendation")}&nbsp;</span>
                <br></br>
                <span className="underline">{t("HomePage.tourLink")}</span>
                <span>&nbsp;{t("HomePage.andToView")}&nbsp;</span>
                <br></br>
                <span className="underline">{t("HomePage.loginLink")}.</span>
            </div>
            </div>
        </main>
