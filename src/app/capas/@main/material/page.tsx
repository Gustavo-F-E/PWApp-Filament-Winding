                ...
                <div className="p-6 max-w-5xl mx-auto bg-white-50 rounded-xl shadow-md border border-blue-50">
                    ...
                    <p className="text-gray-600 mb-8">
                        ...
                        <span className="block mt-1 text-sm text-blue-600 font-semibold">
                            * El botón se activará solo cuando el proyecto
                            alcance el 100% de definición.
                        </span>
                    </p>
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span
                                                    className={`text-xs font-bold ${project.completion_percentage === 100 ? "text-green-600" : "text-gray-500"}`}
                                                >
                                                    {
                    ...
                    <div className="flex justify-center pt-4">
                        <button
                            disabled={!isReady}
                            className={`w-[60%] lg:w-[30%] px-12 py-4 rounded-full font-bold text-lg   shadow-lg transition-all transform hover:scale-105 active:scale-95 ${
                                isReady
