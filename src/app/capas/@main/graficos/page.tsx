...
export default function LinerPage() {
    ...
    const [linerDescription, setLinerDescription] = useState("");
        ...
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/liners/`, {
                ...
                body: JSON.stringify({
                    name:
                        linerName ||
                        `Liner ${selectedProject?.name || "Nuevo"}`,
    ...
    return (
        <div className="flex-1 overflow-y-auto col-[1/13] lg:grid lg:grid-rows-[repeat(17,1fr)] h-full">
            <div className="row-[1/18] lg:col-[1/13] p-4">
                <div className="mb-6 bg-white rounded-xl shadow-md border border-blue-50 p-6">
                    <h1 className="text-2xl font-bold text-blue-950 mb-6 border-b pb-2">
                        Definición de Liner (Mandril)
                    </h1>
                    ...
                    <form onSubmit={handleSave} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    type="text"
                                    className="w-full border rounded-md px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500 text-white-400"
                                    placeholder="Ej: Liner de Vidrio 1"
                                    value={linerName}
                                    onChange={(e) =>
                                        setLinerName(e.target.value)
                                    }
                                    required
                                />
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={(e) =>
                                        setLinerDescription(e.target.value)
                                    }
                                    rows={2}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 text-white-400">
                            {/* Extremo Inicial */}
                            <section className="bg-white-50 p-4 rounded-lg border border-blue-100">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 gap-2 mt-4">
                                        <label className="text-xs font-bold text-white-600">
                                            Diámetro Menor
                                        </label>
                                        <input
                                            type="number"
                                            className="w-full border rounded p-1 text-sm disabled:bg-gray-200 disabled:text-white-400"
                                            disabled={
                                                extremoInicial.tipo ===
                                                "Ninguno"
                                            }
                                            value={
                                                extremoInicial.diametro_menor
                                            }
                                            onChange={(e) =>
                                                setExtremoInicial({
                                                    ...extremoInicial,
                                                    diametro_menor: parseFloat(
                                                        e.target.value,
                                                    ),
                                                })
                                            }
                                        ...
                                        <input
                                            ...
                                            value={
                                                extremoInicial.diametro_mayor
                                            }
                                            onChange={(e) =>
                                                setExtremoInicial({
                                                    ...extremoInicial,
                                                    diametro_mayor: parseFloat(
                                                        e.target.value,
                                                    ),
                                                })
                                            }
