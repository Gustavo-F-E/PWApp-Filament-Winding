...
export default function Registro() {
  ...
  return (
    <section className="h-[calc(100vh-(100vh/24))] w-full flex flex-col lg:grid lg:grid-rows-[repeat(23,1fr)] lg:grid-cols-[repeat(18,1fr)] overflow-hidden">
      ...
      {/* CONTENIDO PRINCIPAL */}
      <main className="flex-1 w-full lg:row-[7/24] lg:col-[1/13] bg-blue-50 lg:h-full overflow-hidden min-h-0">
        <div className="h-full w-full flex justify-center p-4">
          <div className="bg-white w-full max-w-md rounded-xl shadow-2xl overflow-y-auto" style={{ background: 'white' }}>
            ...
            <div className="mt-6 pb-10">
                <div className="text-center text-xs text-gray-500">
                    Para registrarte, debes leer y aceptar nuestros{' '}
                    <button
                    type="button"
              ...
              <div className="flex justify-center space-x-4 mb-6">
                <button
                    ...
                    className={`
                        ...
                        transition-colors 
                        ${!acceptedTerms || isLoading ? 'cursor-not-allowed opacity-50' : 'hover:bg-gray-50'}
                    `}
