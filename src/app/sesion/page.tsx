...
export default function Sesion() {
  ...
  return (
    <section className="h-full w-full flex flex-col lg:grid lg:grid-rows-[repeat(23,1fr)] lg:grid-cols-[repeat(18,1fr)]">
              ...
              <main className=" flex-1 w-full lg:row-[7/24] lg:col-[1/13] bg-blue-50 lg:grid lg:grid-rows-[repeat(17,1fr)] lg:grid-cols-[repeat(12,1fr)] lg:h-full overflow-hidden">
                <div className="lg:row-[1/18] lg:col-[1/13] h-full overflow-auto flex items-center justify-center">
                    <div className="bg-white dark:bg-white w-full max-w-md rounded-xl shadow-2xl p-6"
