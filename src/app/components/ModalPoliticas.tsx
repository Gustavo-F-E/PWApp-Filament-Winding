...
import { CloseIcon } from './IconosSVG'
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Header */}
          <div className="sticky top-0 bg-white border-b border-white-200 p-6 z-10">
          ...
          <div className="p-6 bg-white">
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">1. Aceptación de los Términos</h4>
                <p className="text-white-700 mb-4">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">2. Descripción del Servicio</h4>
                <p className="text-white-700 mb-4">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">3. Cuentas de Usuario</h4>
                <p className="text-white-700 mb-4">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">4. Propiedad Intelectual</h4>
                <p className="text-white-700 mb-4">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">5. Limitación de Responsabilidad</h4>
                <p className="text-white-700 mb-4">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">6. Modificaciones al Servicio</h4>
                <p className="text-white-700 mb-4">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">7. Ley Aplicable</h4>
                <p className="text-white-700 mb-4">
              ...
              <section className="mb-8">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">1. Información que Recopilamos</h4>
                <p className="text-white-700 mb-4">
                  Recopilamos la información que usted nos proporciona directamente, incluyendo:
                </p>
                <ul className="list-disc pl-6 text-white-700 mb-4">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">2. Uso de la Información</h4>
                <p className="text-white-700 mb-4">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">3. Compartir Información</h4>
                <p className="text-white-700 mb-4">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">4. Seguridad de los Datos</h4>
                <p className="text-white-700 mb-4">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">5. Sus Derechos</h4>
                <p className="text-white-700 mb-4">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">6. Cookies</h4>
                <p className="text-white-700 mb-4">
                ...
                <h4 className="text-lg font-medium text-white-900 mb-2">7. Cambios a esta Política</h4>
                <p className="text-white-700 mb-4">
              ...
              {/* Sección de Contacto */}
              <section className="mt-8 p-4 bg-white-50 rounded-lg">
                <h4 className="text-lg font-medium text-white-900 mb-2">Contacto</h4>
          ...
          {/* Footer */}
          <div className="sticky bottom-0 border-t border-white-200 p-4 bg-white rounded-b-xl">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="text-sm text-white-500 text-center sm:text-left">
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={onClose}
                  className="px-4 py-2 border border-white-300 text-white-700 rounded-lg hover:bg-white-50 transition-colors font-medium"
                >
                  Cerrar
                </button>
              </div>
